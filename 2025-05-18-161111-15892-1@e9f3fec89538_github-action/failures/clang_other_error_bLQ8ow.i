...
static void ev_link_init (EvLink *self); static void ev_link_class_init (EvLinkClass *klass); static GType ev_link_get_type_once (void); static gpointer ev_link_parent_class = ((void*)0); static gint EvLink_private_offset; static void ev_link_class_intern_init (gpointer klass) { ev_link_parent_class = g_type_class_peek_parent (klass); if (EvLink_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvLink_private_offset); ev_link_class_init ((EvLinkClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_link_get_instance_private (EvLink *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvLink_private_offset)))); } GType ev_link_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_link_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_link_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvLink"), sizeof (EvLinkClass), (GClassInitFunc)(void (*)(void)) ev_link_class_intern_init, sizeof (EvLink), (GInstanceInitFunc)(void (*)(void)) ev_link_init, (GTypeFlags) 0); { {{ EvLink_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EvLinkPrivate)); };} } return g_define_type_id; }

const gchar *
ev_link_get_title (EvLink *self)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK (self)"); return (((void*)0)); } } while (0);
        ...
        GParamSpec *param_spec)
{
 ...
 switch (prop_id) {
   ...
   break;
         default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((param_spec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-link.c", 82, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
...
ev_link_set_property (GObject *object,
        ...
        GParamSpec *param_spec)
{
 EvLink *self = ((((EvLink*) (void *) ((object)))));
 ...
 switch (prop_id) {
   ...
   break;
         default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((param_spec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-link.c", 105, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
...
ev_link_finalize (GObject *object)
{
 ...
 ((((GObjectClass*) (void *) ((ev_link_parent_class)))))->finalize (object);
}
...
ev_link_init (EvLink *ev_link)
{
 ...
 ev_link->priv->title = ((void*)0);
 ev_link->priv->action = ((void*)0);
}
...
ev_link_class_init (EvLinkClass *ev_window_class)
{
 ...
 g_object_class = ((((GObjectClass*) (void *) ((ev_window_class)))));
...
ev_link_new (const char *title,
      EvLinkAction *action)
{
 return ((((EvLink*) (void *) ((g_object_new ((ev_link_get_type()), "title", title, "action", action, ((void*)0)))))));
