# 1 "ev-document-print.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 408 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-document-print.c" 2
# 21 "ev-document-print.c"
# 1 "../config.h" 1
# 22 "ev-document-print.c" 2
...
# 24 "ev-document-print.c" 2
# 1 "./ev-document-print.h" 1
# 27 "./ev-document-print.h"
# 1 "./ev-page.h" 1
# 28 "./ev-document-print.h" 2
# 38 "./ev-document-print.h"
...
ev_document_print_print_page (EvDocumentPrint *document_print,
         ...
         cairo_t *cr)
{
 EvDocumentPrintInterface *iface = ((((EvDocumentPrintInterface*) g_type_interface_peek (((GTypeInstance*) ((document_print)))->g_class, ((ev_document_print_get_type ()))))));
