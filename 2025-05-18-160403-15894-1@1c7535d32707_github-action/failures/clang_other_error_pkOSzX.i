...
GType ev_layer_get_type (void) __attribute__ ((__const__));
...
static void ev_layer_init (EvLayer *self); static void ev_layer_class_init (EvLayerClass *klass); static GType ev_layer_get_type_once (void); static gpointer ev_layer_parent_class = ((void*)0); static gint EvLayer_private_offset; static void ev_layer_class_intern_init (gpointer klass) { ev_layer_parent_class = g_type_class_peek_parent (klass); if (EvLayer_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvLayer_private_offset); ev_layer_class_init ((EvLayerClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_layer_get_instance_private (EvLayer *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvLayer_private_offset)))); } GType ev_layer_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_layer_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_layer_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvLayer"), sizeof (EvLayerClass), (GClassInitFunc)(void (*)(void)) ev_layer_class_intern_init, sizeof (EvLayer), (GInstanceInitFunc)(void (*)(void)) ev_layer_init, (GTypeFlags) 0); { {{ EvLayer_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EvLayerPrivate)); };} } return g_define_type_id; }
       ...
       gint rb_group)
{
 ...
 layer = ((((EvLayer*) (void *) ((g_object_new ((ev_layer_get_type()), ((void*)0)))))));
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layer)); GType __t = ((ev_layer_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LAYER (layer)"); return ((0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layer)); GType __t = ((ev_layer_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LAYER (layer)"); return (0); } } while (0);
