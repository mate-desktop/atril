...
static ListHead specials = {((void*)0), ((void*)0), 0};




static void sp_layer (DviContext *, const char *, const char *);
extern void epsf_special (DviContext *, const char *, const char *);
extern void do_color_special (DviContext *, const char *, const char *);
...
static struct {
 ...
 {"Layers", "layer", ((void*)0), sp_layer},
 {"EPSF", "psfile", ((void*)0), epsf_special}
};
...
static void register_builtin_specials(void)
{
 ...
 do { if(!(registered_builtins == 0)) mdvi_crash("%s:%d: Assertion %s failed\n", "special.c", 68, "registered_builtins == 0"); } while(0);
...
static DviSpecial *find_special_prefix(const char *prefix)
{
 ...
 for(sp = (DviSpecial *)specials.head; sp; sp = sp->next) {
  if((strcasecmp((sp->prefix), (prefix)) == 0))
   break;
 }
 return sp;
}
 ...
 const char *regex, DviSpecialHandler handler, int replace)
{
 ...
 if(sp == ((void*)0)) {
  sp = (DviSpecial *)mdvi_malloc(sizeof(DviSpecial));
...
# 126 "special.c"
 ...
 __debug ((1 << 5), "New \\special handler `%s' with prefix `%s'\n", label, prefix);
...
int mdvi_do_special(DviContext *dvi, char *string)
{
 ...
 while(*string && ((*__ctype_b_loc ())[(int) ((*string))] & (unsigned short int) _ISspace))
  string++;

 __debug ((1 << 5), "Looking for a handler for `%s'\n", string);
 ...
 for(sp = (DviSpecial *)specials.head; sp; sp = sp->next) {
  ...
  if((strncasecmp((sp->prefix), (ptr), (sp->plen)) == 0)) {
   ptr += sp->plen;
   break;
  }
 }
 ...
 if(ptr == string) {
  prefix = ((void*)0);
  __debug ((1 << 5), "REGEX match with `%s' (arg `%s')\n", sp->label, ptr);


 } else {
  if(*ptr) *ptr++ = 0;
  prefix = string;
  __debug ((1 << 5), "PREFIX match with `%s' (prefix `%s', arg `%s')\n", sp->label, prefix, ptr);
...
void mdvi_flush_specials(void)
{
 ...
 specials.head = ((void*)0);
 specials.tail = ((void*)0);
 specials.count = 0;
}
...
{
 if(((("push") != ((void*)0)) && ((arg) != ((void*)0)) && (strcmp ("push", arg) == 0)))
  dvi->curr_layer++;
 else if(((("pop") != ((void*)0)) && ((arg) != ((void*)0)) && (strcmp ("pop", arg) == 0))) {
  if(dvi->curr_layer)
   dvi->curr_layer--;
  else
   mdvi_warning(((char *) g_dgettext ("atril", "%s: tried to pop top level layer\n")),
         dvi->filename);
 } else if(((("reset") != ((void*)0)) && ((arg) != ((void*)0)) && (strcmp ("reset", arg) == 0)))
  dvi->curr_layer = 0;
 __debug ((1 << 5), "Layer level: %d\n", dvi->curr_layer);
}
