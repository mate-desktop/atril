# 1 "ev-backends-manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-backends-manager.c" 2
# 20 "ev-backends-manager.c"
# 1 "../config.h" 1
# 21 "ev-backends-manager.c" 2

# 1 "/usr/include/glib-2.0/glib/gstdio.h" 1
# 24 "/usr/include/glib-2.0/glib/gstdio.h"
# 1 "/usr/include/glib-2.0/glib/gprintf.h" 1
# 23 "/usr/include/glib-2.0/glib/gprintf.h"
...
# 24 "/usr/include/glib-2.0/glib/gprintf.h" 2
...
GType ev_module_get_type (void) __attribute__ ((__const__));
...
# 26 "ev-backends-manager.c" 2
# 1 "./ev-backends-manager.h" 1
# 29 "./ev-backends-manager.h"
# 1 "./ev-document.h" 1
# 33 "./ev-document.h"
...
# 30 "./ev-backends-manager.h" 2
# 1 "./ev-macros.h" 1
# 31 "./ev-backends-manager.h" 2
...
# 27 "ev-backends-manager.c" 2

static GList *ev_backends_list = ((void*)0);
...
static gchar *backendsdir = ((void*)0);

static const gchar *
backends_dir (void)
{
 if (!backendsdir) {
  backendsdir = g_strdup_inline ("/usr/local/lib/atril/3/backends");
 }
...
{
 EvBackendInfo *info;
 GKeyFile *backend_file = ((void*)0);
 GError *error = ((void*)0);

 backend_file = g_key_file_new ();
 if (!g_key_file_load_from_file (backend_file, file, G_KEY_FILE_NONE, &error)) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Error opening backend file %s: %s", file, error->message);
 ...
 info = (EvBackendInfo *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (EvBackendInfo); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 info->module_name = g_key_file_get_string (backend_file, "Atril Backend",
         "Module", ((void*)0));
 if (!info->module_name) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Bad atril backend file %s: Could not find 'Module'", file);
 ...
 info->resident = g_key_file_get_boolean (backend_file, "Atril Backend",
       "Resident", ((void*)0));

 info->type_desc = g_key_file_get_locale_string (backend_file, "Atril Backend",
       "TypeDescription", ((void*)0), ((void*)0));
 if (!info->type_desc) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Bad atril backend file %s: Could not find 'TypeDescription'", file);
 ...
 info->mime_types = g_key_file_get_string_list (backend_file, "Atril Backend",
             "MimeType", ((void*)0), ((void*)0));
 if (!info->mime_types) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Bad atril backend file %s: Could not find 'MimeType'", file);
...
ev_backends_manager_load (void)
{
 ...
 if (!dir) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s", error->message);
  g_error_free (error);
 ...
 while ((dirent = g_dir_read_name (dir))) {
  ...
  if (!(__builtin_constant_p (".atril-backend")? __extension__ ({ const char * const __str = (dirent); const char * const __suffix = (".atril-backend"); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (__str == ((void*)0) || __suffix == ((void*)0)) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 0)) __result = (g_str_has_suffix) (__str, __suffix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __suffix_len = strlen (((__suffix) + !(__suffix))); if (__str_len >= __suffix_len) __result = memcmp (__str + __str_len - __suffix_len, ((__suffix) + !(__suffix)), __suffix_len) == 0; } __result; }) : (g_str_has_suffix) (dirent, ".atril-backend") ))
   continue;

  file = g_build_filename (backends_dir(), dirent, ((void*)0));
 ...
 return ev_backends_list != ((void*)0);
}
# 175 "ev-backends-manager.c"
gboolean
...
{
 g_list_foreach (ev_backends_list, (GFunc)ev_backend_info_free, ((void*)0));
 g_list_free (ev_backends_list);
 ev_backends_list = ((void*)0);
...
ev_backends_manager_get_backend_info (const gchar *mime_type)
{
 ...
 for (l = ev_backends_list; l; l = ((l) ? (((GList *)(l))->next) : ((void*)0))) {
  EvBackendInfo *info;
  gint i = 0;
  const char *mime;
...
ev_backends_manager_get_document (const gchar *mime_type)
{
 ...
 if (!info->module) {
  ...
  info->module = ((((GTypeModule*) (void *) ((ev_module_new (path, info->resident))))));
  g_free (path);
 }

 if (!g_type_module_use (info->module)) {
  g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Cannot load backend '%s' since file '%s' cannot be read.", info->module_name, ev_module_get_path (((((EvModule*) (void *) ((info->module)))))));


  g_object_unref (((((GObject*) (void *) ((info->module))))));
  info->module = ((void*)0);

  return ((void*)0);
 }

 document = ((((EvDocument*) (void *) ((ev_module_new_object (((((EvModule*) (void *) ((info->module)))))))))));
...
get_document_backend_info (EvDocument *document)
{
 ...
 for (l = ev_backends_list; l; l = ((l) ? (((GList *)(l))->next) : ((void*)0))) {
  ...
  type_id = ev_module_get_object_type (((((EvModule*) (void *) ((info->module))))));

  if (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) (document); GType __t = (type_id); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) {
   return info;
  }
 }
...
ev_backends_manager_get_document_module_name (EvDocument *document)
{
 ...
 return info ? info->module_name : ((void*)0);
}
...
ev_type_info_new (const gchar *desc, const gchar **mime_types)
{
 ...
 info = (EvTypeInfo *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (EvTypeInfo); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
