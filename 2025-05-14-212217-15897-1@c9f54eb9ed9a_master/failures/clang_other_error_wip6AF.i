...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-link-action.c" 2
# 21 "ev-link-action.c"
# 1 "../config.h" 1
# 22 "ev-link-action.c" 2
...
static void ev_link_action_init (EvLinkAction *self); static void ev_link_action_class_init (EvLinkActionClass *klass); static GType ev_link_action_get_type_once (void); static gpointer ev_link_action_parent_class = ((void*)0); static gint EvLinkAction_private_offset; static void ev_link_action_class_intern_init (gpointer klass) { ev_link_action_parent_class = g_type_class_peek_parent (klass); if (EvLinkAction_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvLinkAction_private_offset); ev_link_action_class_init ((EvLinkActionClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_link_action_get_instance_private (EvLinkAction *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvLinkAction_private_offset)))); } GType ev_link_action_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_link_action_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_link_action_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvLinkAction"), sizeof (EvLinkActionClass), (GClassInitFunc)(void (*)(void)) ev_link_action_class_intern_init, sizeof (EvLinkAction), (GInstanceInitFunc)(void (*)(void)) ev_link_action_init, (GTypeFlags) 0); { {{ EvLinkAction_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EvLinkActionPrivate)); };} } return g_define_type_id; }

EvLinkActionType
ev_link_action_get_action_type (EvLinkAction *self)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (0); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_14 = 1; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_15 = 1; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_17 = 1; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_18 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((self)); GType __t = ((ev_link_action_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_18 = 1; _g_boolean_var_18; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_LINK_ACTION (self)"); return (((void*)0)); } } while (0);
        ...
        GParamSpec *param_spec)
{
 ...
 switch (prop_id) {
   ...
   break;
         default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((param_spec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-link-action.c", 175, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
...
ev_link_action_set_property (GObject *object,
        ...
        GParamSpec *param_spec)
{
 EvLinkAction *self = ((((EvLinkAction*) (void *) ((object)))));
 ...
 switch (prop_id) {
   ...
   break;
         default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((param_spec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-link-action.c", 223, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
...
ev_link_action_finalize (GObject *object)
{
 ...
 priv = ((((EvLinkAction*) (void *) ((object)))))->priv;
 ...
 if (priv->show_list) {
  g_list_foreach (priv->show_list, (GFunc)g_object_unref, ((void*)0));
  g_list_free (priv->show_list);
  priv->show_list = ((void*)0);
 }

 if (priv->hide_list) {
  g_list_foreach (priv->hide_list, (GFunc)g_object_unref, ((void*)0));
  g_list_free (priv->hide_list);
  priv->hide_list = ((void*)0);
 }

 if (priv->toggle_list) {
  g_list_foreach (priv->toggle_list, (GFunc)g_object_unref, ((void*)0));
  g_list_free (priv->toggle_list);
  priv->toggle_list = ((void*)0);
 }

 ((((GObjectClass*) (void *) ((ev_link_action_parent_class)))))->finalize (object);
}
...
ev_link_action_init (EvLinkAction *ev_link_action)
{
 ...
 ev_link_action->priv->dest = ((void*)0);
 ev_link_action->priv->uri = ((void*)0);
 ev_link_action->priv->filename = ((void*)0);
 ev_link_action->priv->params = ((void*)0);
 ev_link_action->priv->name = ((void*)0);
}
...
ev_link_action_class_init (EvLinkActionClass *ev_link_action_class)
{
 ...
 g_object_class = ((((GObjectClass*) (void *) ((ev_link_action_class)))));
...
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "dest", dest, "type", EV_LINK_ACTION_TYPE_GOTO_DEST, ((void*)0)))))));
...
ev_link_action_new_remote (EvLinkDest *dest,
      const gchar *filename)
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "dest", dest, "filename", filename, "type", EV_LINK_ACTION_TYPE_GOTO_REMOTE, ((void*)0)))))));
...
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "uri", uri, "type", EV_LINK_ACTION_TYPE_EXTERNAL_URI, ((void*)0)))))));
...
ev_link_action_new_launch (const gchar *filename,
      const gchar *params)
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "filename", filename, "params", params, "type", EV_LINK_ACTION_TYPE_LAUNCH, ((void*)0)))))));
...
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "name", name, "type", EV_LINK_ACTION_TYPE_NAMED, ((void*)0)))))));
...
ev_link_action_new_layers_state (GList *show_list,
     ...
     GList *toggle_list)
{
 return ((((EvLinkAction*) (void *) ((g_object_new ((ev_link_action_get_type()), "show-list", show_list, "hide-list", hide_list, "toggle-list", toggle_list, "type", EV_LINK_ACTION_TYPE_LAYERS_STATE, ((void*)0)))))));
