...
static void ev_page_init (EvPage *self); static void ev_page_class_init (EvPageClass *klass); static GType ev_page_get_type_once (void); static gpointer ev_page_parent_class = ((void*)0); static gint EvPage_private_offset; static void ev_page_class_intern_init (gpointer klass) { ev_page_parent_class = g_type_class_peek_parent (klass); if (EvPage_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvPage_private_offset); ev_page_class_init ((EvPageClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_page_get_instance_private (EvPage *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvPage_private_offset)))); } GType ev_page_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_page_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_page_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvPage"), sizeof (EvPageClass), (GClassInitFunc)(void (*)(void)) ev_page_class_intern_init, sizeof (EvPage), (GInstanceInitFunc)(void (*)(void)) ev_page_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
...
{
 EvPage *page = ((((EvPage*) (void *) ((object)))));

 if (page->backend_destroy_func) {
  page->backend_destroy_func (page->backend_page);
  page->backend_destroy_func = ((void*)0);
 }
 page->backend_page = ((void*)0);

 (* ((((GObjectClass*) (void *) ((ev_page_parent_class)))))->finalize) (object);
}
...
ev_page_new (gint index)
{
 ...
 page = ((((EvPage*) (void *) ((g_object_new ((ev_page_get_type()), ((void*)0)))))));
 page->index = index;
