...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-mapping-list.c" 2
# 21 "ev-mapping-list.c"
# 1 "./ev-mapping-list.h" 1
# 28 "./ev-mapping-list.h"
# 1 "./ev-document.h" 1
# 30 "./ev-document.h"
...
GType ev_mapping_list_get_type (void) __attribute__ ((__const__));
...
static GType ev_mapping_list_get_type_once (void); GType ev_mapping_list_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_mapping_list_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_mapping_list_get_type_once (void) { GType (* _g_register_boxed) (const gchar *, union { EvMappingList * (*do_copy_type) (EvMappingList *); EvMappingList * (*do_const_copy_type) (const EvMappingList *); GBoxedCopyFunc do_copy_boxed; } __attribute__((__transparent_union__)), union { void (* do_free_type) (EvMappingList *); GBoxedFreeFunc do_free_boxed; } __attribute__((__transparent_union__)) ) = g_boxed_type_register_static; GType g_define_type_id = _g_register_boxed (g_intern_static_string ("EvMappingList"), ev_mapping_list_ref, ev_mapping_list_unref); { {{};} } return g_define_type_id; }
# 39 "ev-mapping-list.c"
EvMapping *
...
# 87 "ev-mapping-list.c"
EvMapping *
ev_mapping_list_nth (EvMappingList *mapping_list,
                     guint n)
{
        do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (mapping_list != ((void*)0)) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (((void*)0)); } } while (0);

        return (EvMapping *)g_list_nth_data (mapping_list->list, n);
}
# 104 "ev-mapping-list.c"
EvMapping *
...
{
 return mapping_list ? mapping_list->list : ((void*)0);
}
# 168 "ev-mapping-list.c"
void
...
{
        do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if (mapping_list != ((void*)0)) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (0); } } while (0);

        return g_list_length (mapping_list->list);
}
# 199 "ev-mapping-list.c"
EvMappingList *
       ...
       GDestroyNotify data_destroy_func)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if (data_destroy_func != ((void*)0)) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "data_destroy_func != NULL"); return (((void*)0)); } } while (0);

 mapping_list = ((EvMappingList*) g_slice_alloc (sizeof (EvMappingList)));
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if (mapping_list != ((void*)0)) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14 = 0; if (mapping_list->ref_count > 0) _g_boolean_var_14 = 1; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list->ref_count > 0"); return (mapping_list); } } while (0);

 (__extension__ ({ _Static_assert (sizeof *(&mapping_list->ref_count) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&mapping_list->ref_count) ^ (1) : 1); (gint) __atomic_fetch_add ((&mapping_list->ref_count), (1), 5); }));
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15 = 0; if (mapping_list != ((void*)0)) _g_boolean_var_15 = 1; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16 = 0; if (mapping_list->ref_count > 0) _g_boolean_var_16 = 1; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list->ref_count > 0"); return; } } while (0);

 if ((__extension__ ({ _Static_assert (sizeof *(&mapping_list->ref_count) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&mapping_list->ref_count) ^ (-1) : 1); (gint) __atomic_fetch_add ((&mapping_list->ref_count), (-1), 5); })) - 1 == 0) {
  ...
  do { if (1) g_slice_free1 (sizeof (EvMappingList), (mapping_list)); else (void) ((EvMappingList*) 0 == (mapping_list)); } while (0);
 }
}
