# 1 "ev-render-context.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-render-context.c" 2
# 20 "ev-render-context.c"
# 1 "../config.h" 1
# 21 "ev-render-context.c" 2
# 1 "./ev-render-context.h" 1
# 27 "./ev-render-context.h"
...
void ev_render_context_set_scale (EvRenderContext *rc,
          gdouble scale);
# 22 "ev-render-context.c" 2

static void ev_render_context_init (EvRenderContext *self); static void ev_render_context_class_init (EvRenderContextClass *klass); static GType ev_render_context_get_type_once (void); static gpointer ev_render_context_parent_class = ((void*)0); static gint EvRenderContext_private_offset; static void ev_render_context_class_intern_init (gpointer klass) { ev_render_context_parent_class = g_type_class_peek_parent (klass); if (EvRenderContext_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvRenderContext_private_offset); ev_render_context_class_init ((EvRenderContextClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_render_context_get_instance_private (EvRenderContext *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvRenderContext_private_offset)))); } GType ev_render_context_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_render_context_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_render_context_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvRenderContext"), sizeof (EvRenderContextClass), (GClassInitFunc)(void (*)(void)) ev_render_context_class_intern_init, sizeof (EvRenderContext), (GInstanceInitFunc)(void (*)(void)) ev_render_context_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };
...
ev_render_context_dispose (GObject *object)
{
 ...
 (* ((((GObjectClass*) (void *) ((ev_render_context_parent_class)))))->dispose) (object);
}
...
ev_render_context_class_init (EvRenderContextClass *class)
{
 ...
 oclass = ((((GObjectClass*) (void *) ((class)))));
         ...
         gdouble scale)
{
 ...
 rc = (EvRenderContext *) g_object_new ((ev_render_context_get_type()), ((void*)0));

 rc->page = page ? ((__typeof__ (page)) (g_object_ref) (page)) : ((void*)0);
...
ev_render_context_set_page (EvRenderContext *rc,
       EvPage *page)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (rc != ((void*)0)) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((page)); GType __t = ((ev_page_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_PAGE (page)"); return; } } while (0);

 if (rc->page)
  g_object_unref (rc->page);
 rc->page = ((__typeof__ (page)) (g_object_ref) (page));
}
...
ev_render_context_set_rotation (EvRenderContext *rc,
    int rotation)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if (rc != ((void*)0)) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
...
ev_render_context_set_scale (EvRenderContext *rc,
        gdouble scale)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if (rc != ((void*)0)) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
