...
# 1 "/usr/include/kpathsea/expand.h" 1 3 4
# 42 "/usr/include/kpathsea/expand.h" 3 4
...
# 31 "fontmap.c" 2
# 1 "/usr/include/kpathsea/pathsearch.h" 1 3 4
# 86 "/usr/include/kpathsea/pathsearch.h" 3 4
extern string kpathsea_path_search
  (kpathsea kpse, const_string path, const_string name, boolean must_exist);



extern string *kpathsea_all_path_search
  (kpathsea kpse, const_string path, const_string name);
# 105 "/usr/include/kpathsea/pathsearch.h" 3 4
extern string kpse_path_search
  (const_string path, const_string name, boolean must_exist);
extern string *kpse_all_path_search
...
static char *pslibdir = ((void*)0);
static char *psfontdir = ((void*)0);
static int psinitialized = 0;

static ListHead psfonts = {((void*)0), ((void*)0), 0};
static DviHashTable pstable = {((void*)0), 0, 0, ((void*)0), ((void*)0), ((void*)0)};

static ListHead fontmaps;
static DviHashTable maptable;
static int fontmaps_loaded = 0;
# 68 "fontmap.c"
static ListHead encodings = {((void*)0), ((void*)0), 0};
static DviEncoding *tex_text_encoding = ((void*)0);
static DviEncoding *default_encoding = ((void*)0);



static DviHashTable enctable = {((void*)0), 0, 0, ((void*)0), ((void*)0), ((void*)0)};
static DviHashTable enctable_file = {((void*)0), 0, 0, ((void*)0), ((void*)0), ((void*)0)};
...
static void ps_init_default_paths (void);
...
static int read_encoding(DviEncoding *enc)
{
 ...
 do { if(!(enc->private == ((void*)0))) mdvi_crash("%s:%d: Assertion %s failed\n", "fontmap.c", 120, "enc->private == NULL"); } while(0);

 in = kpse_fopen_trace(enc->filename, "rb");
 if(in == ((void*)0)) {
  __debug ((1 << 17), "%s: could not read `%s' (%s)\n", enc->name, enc->filename, strerror((*__errno_location ())));

  return -1;
 }
 if(fstat(fileno(in), &st) < 0) {

  kpse_fclose_trace(in);
  return -1;
 }
 ...
 mdvi_hash_create(&enc->nametab, 131);

 enc->vector = (char **)mdvi_malloc(256 * sizeof(char *));


 fseek(in, enc->offset, 0);
 ...
 for(line = enc->private; *line && curr < 256; line = next) {
  ...
  if(!(((name) != ((void*)0)) && ((".notdef") != ((void*)0)) && (strcmp (name, ".notdef") == 0))) {
   mdvi_hash_add(&enc->nametab, ((DviHashKey)(name)),
    ((Pointer)((INT)(curr + 1))), 0);
  }
  curr++;
 }
 if(curr == 0) {
...
static DviEncoding *find_encoding(const char *name)
{
 return (DviEncoding *)(encodings.count ?
  mdvi_hash_lookup(&enctable, ((DviHashKey)(name))) : ((void*)0));
}
...
static DviEncoding *register_encoding(const char *basefile, int replace)
{
 ...
 __debug ((1 << 17), "register_encoding(%s)\n", basefile);

 if(encodings.count) {
  enc = mdvi_hash_lookup(&enctable_file, ((DviHashKey)(basefile)));
  if(enc != ((void*)0)) {
   __debug ((1 << 17), "%s: already there\n", basefile);
   return enc;
  }
 }
 ...
 in = kpse_fopen_trace(filename, "rb");
 if(in == ((void*)0)) {
  mdvi_free(filename);
  return ((void*)0);
 }
 ...
 name = ((void*)0);
 dstring_init(&input);
 while((line = dgets(&input, in)) != ((void*)0)) {
  if(((line) && ("Encoding=") && (strncmp (line, "Encoding=", 9) == 0))) {
 ...
 if(name == ((void*)0) || *name == 0) {
  __debug ((1 << 17), "%s: could not determine name of encoding\n", basefile);
 ...
 if(enc == tex_text_encoding) {
  ...
  mdvi_hash_remove(&enctable, ((DviHashKey)(enc->name)));
  if(enc == default_encoding)
  ...
  if(replace) {
   mdvi_hash_remove(&enctable, ((DviHashKey)(name)));
   mdvi_hash_remove(&enctable_file, ((DviHashKey)(basefile)));
   listh_remove(&encodings, ((List *)(enc)));
   if(enc == default_encoding) {
    default_encoding = ((void*)0);
    mdvi_release_encoding(enc, 1);
   }
   __debug ((1 << 17), "%s: overriding encoding\n", name);
 ...
 enc = (DviEncoding *)mdvi_malloc(sizeof(DviEncoding));
 ...
 dstring_reset(&input);
 if(default_encoding == ((void*)0))
  default_encoding = enc;
 mdvi_hash_add(&enctable, ((DviHashKey)(enc->name)),
  enc, 2);
 mdvi_hash_add(&enctable_file, ((DviHashKey)(mdvi_strdup(basefile))),
  enc, 0);
 listh_prepend(&encodings, ((List *)(enc)));
 __debug ((1 << 17), "%s: encoding `%s' registered\n", basefile, enc->name);
...
DviEncoding *mdvi_request_encoding(const char *name)
{
 ...
 if(enc == ((void*)0)) {
  __debug ((1 << 17), "%s: encoding not found, returning default `%s'\n", name, default_encoding->name);
 ...
 if(enc->nametab.nkeys == 0) {
  ...
  __debug ((1 << 17), "%s: rehashing\n", enc->name);
  for(i = 0; i < 256; i++) {
   if(enc->vector[i] == ((void*)0))
    continue;
   mdvi_hash_add(&enc->nametab,
    ((DviHashKey)(enc->vector[i])),
    (DviHashKey)((Pointer)((INT)(i))),
    0);
  }
 }
 return enc;
...
void mdvi_release_encoding(DviEncoding *enc, int should_free)
{
 ...
 if(!enc->links || --enc->links > 0 || !should_free)
  return;
 __debug ((1 << 17), "%s: resetting encoding vector\n", enc->name);
 mdvi_hash_reset(&enc->nametab, 1);
}
...
int mdvi_encode_glyph(DviEncoding *enc, const char *name)
{
 ...
 data = mdvi_hash_lookup(&enc->nametab, ((DviHashKey)(name)));
 if(data == ((void*)0))
  return -1;
...
static void parse_spec(DviFontMapEnt *ent, char *spec)
{
 ...
 while(*spec) {
  ...
  if(!arg || !command)
   continue;
  if((((command) != ((void*)0)) && (("SlantFont") != ((void*)0)) && (strcmp (command, "SlantFont") == 0))) {
   double x = 10000 * strtod(arg, 0);


   ent->slant = (int)((x) >= 0 ? floor((x) + 0.5) : ceil((x) + 0.5));
  } else if((((command) != ((void*)0)) && (("ExtendFont") != ((void*)0)) && (strcmp (command, "ExtendFont") == 0))) {
   double x = 10000 * strtod(arg, 0);

   ent->extend = (int)((x) >= 0 ? floor((x) + 0.5) : ceil((x) + 0.5));
  } else if((((command) != ((void*)0)) && (("ReEncodeFont") != ((void*)0)) && (strcmp (command, "ReEncodeFont") == 0))) {
   if(ent->encoding)
...
DviFontMapEnt *mdvi_load_fontmap(const char *file)
{
 ...
 if(ptr == ((void*)0))
  in = kpse_fopen_trace(file, "rb");
 else {
  in = kpse_fopen_trace(ptr, "rb");
  mdvi_free(ptr);
 }
 if(in == ((void*)0))
  return ((void*)0);
 ...
 listh_init(&list);
 dstring_init(&input);
 last_encoding = ((void*)0);
 last_encfile = ((void*)0);

 while((ptr = dgets(&input, in)) != ((void*)0)) {
  char *font_file;
  char *tex_name;
  char *ps_name;
  char *vec_name;
  ...
  if(ent == ((void*)0)) {
   ent = (DviFontMapEnt *)mdvi_malloc(sizeof(DviFontMapEnt));
   ent->encoding = ((void*)0);
   ent->slant = 0;
   ent->extend = 0;
  }
  while(*ptr) {
   char *hdr_name = ((void*)0);
   ...
   if(hdr_name) {
    ...
    if(is_encoding || (ext && (strcasecmp((ext), ("enc")) == 0)))
     vec_name = hdr_name;
    else
     font_file = hdr_name;
   }
  ...
  ent->psname = ps_name ? mdvi_strdup(ps_name) : ((void*)0);
  ent->fontfile = font_file ? mdvi_strdup(font_file) : ((void*)0);
  ent->encfile = vec_name ? mdvi_strdup(vec_name) : ((void*)0);
  ent->fullfile = ((void*)0);
  enc = ((void*)0);
  ...
  if(ent->encfile) {
   ...
   if(!last_encfile || !(((last_encfile) != ((void*)0)) && ((ent->encfile) != ((void*)0)) && (strcmp (last_encfile, ent->encfile) == 0))) {
  ...
  if(ent->encfile && enc){
   if(ent->encoding && !(((ent->encoding) != ((void*)0)) && ((enc->name) != ((void*)0)) && (strcmp (ent->encoding, enc->name) == 0))) {
    mdvi_warning(
 ((char *) g_dgettext ("atril", "%s: %d: [%s] requested encoding `%s' does not match vector `%s'\n")),
...
{
 do { if(!(ent->fontname != ((void*)0))) mdvi_crash("%s:%d: Assertion %s failed\n", "fontmap.c", 610, "ent->fontname != NULL"); } while(0);
...
void mdvi_install_fontmap(DviFontMapEnt *head)
{
 ...
 for(ent = head; ent; ent = next) {
  ...
  old = (DviFontMapEnt *)
   mdvi_hash_remove(&maptable, ((DviHashKey)(ent->fontname)));
  if(old != ((void*)0)) {
   __debug ((1 << 17), "%s: overriding fontmap entry\n", old->fontname);

   listh_remove(&fontmaps, ((List *)(old)));
   free_ent(old);
  }
  next = ent->next;
  mdvi_hash_add(&maptable, ((DviHashKey)(ent->fontname)),
   ent, 2);
...
static void init_static_encoding(void)
{
 ...
 __debug ((1 << 17), "installing static TeX text encoding\n");
 encoding = (DviEncoding *)mdvi_malloc(sizeof(DviEncoding));
 encoding->private = "";
 encoding->filename = "";
 ...
 encoding->links = 1;
 encoding->offset = 0;
 mdvi_hash_create(&encoding->nametab, 131);
 for(i = 0; i < 256; i++) {
  if(encoding->vector[i]) {
   mdvi_hash_add(&encoding->nametab,
    ((DviHashKey)(encoding->vector[i])),
    (DviHashKey)((Pointer)((INT)(i))),
    2);
  }
 }
 do { if((encodings.count) != (0)) mdvi_crash("%s:%d: Assertion failed (%d = %s != %s)\n", "fontmap.c", 670, (encodings.count), "encodings.count", "encodings.count"); } while(0);
 mdvi_hash_create(&enctable, 31);
 mdvi_hash_create(&enctable_file, 31);
 enctable_file.hash_free = file_hash_free;
 mdvi_hash_add(&enctable, ((DviHashKey)(encoding->name)),
  encoding, 2);
...
static int mdvi_init_fontmaps(void)
{
 ...
 __debug ((1 << 17), "reading fontmaps\n");


 init_static_encoding();


 mdvi_hash_create(&maptable, 57);
 ...
 while((line = dgets(&input, in)) != ((void*)0)) {
  ...
  if(*line < ' ' || *line == '#' || *line == '%')
   continue;
  if(((line) && ("fontmap") && (strncmp (line, "fontmap", 7) == 0))) {
   DviFontMapEnt *ent;

   arg = getstring(line + 7, " \t", &line); *line = 0;
   __debug ((1 << 17), "%s: loading fontmap\n", arg);
   ...
   if(ent == ((void*)0))
    mdvi_warning(((char *) g_dgettext ("atril", "%s: could not load fontmap\n")), arg);
   else {
    __debug ((1 << 17), "%s: installing fontmap\n", arg);

    mdvi_install_fontmap(ent);
    count++;
   }
  } else if(((line) && ("encoding") && (strncmp (line, "encoding", 8) == 0))) {
   arg = getstring(line + 8, " \t", &line); *line = 0;
   if(arg && *arg)
    register_encoding(arg, 1);
  } else if(((line) && ("default-encoding") && (strncmp (line, "default-encoding", 16) == 0))) {
   arg = getstring(line + 16, " \t", &line); *line = 0;
   if(mdvi_set_default_encoding(arg) < 0)
    mdvi_warning(((char *) g_dgettext ("atril", "%s: could not set as default encoding\n")),
          arg);
  } else if(((line) && ("psfontpath") && (strncmp (line, "psfontpath", 10) == 0))) {
  ...
  } else if(((line) && ("pslibpath") && (strncmp (line, "pslibpath", 9) == 0))) {
  ...
  } else if(((line) && ("psfontmap") && (strncmp (line, "psfontmap", 9) == 0))) {
 ...
 dstring_reset(&input);
 fontmaps_loaded = 1;
 __debug ((1 << 17), "%d files installed, %d fontmaps\n", count, fontmaps.count);
...
int mdvi_query_fontmap(DviFontMapInfo *info, const char *fontname)
{
 ...
 if(!fontmaps_loaded && mdvi_init_fontmaps() < 0)
  return -1;
 ent = (DviFontMapEnt *)mdvi_hash_lookup(&maptable, ((DviHashKey)(fontname)));
...
int mdvi_add_fontmap_file(const char *name, const char *fullpath)
{
 ...
 if(!fontmaps_loaded && mdvi_init_fontmaps() < 0)
  return -1;
 ent = (DviFontMapEnt *)mdvi_hash_lookup(&maptable, ((DviHashKey)(name)));
 if(ent == ((void*)0))
  return -1;
 if(ent->fullfile)
  mdvi_free(ent->fullfile);
...
void mdvi_flush_fontmaps(void)
{
 ...
 __debug ((1 << 17), "flushing %d fontmaps\n", fontmaps.count);
...
void ps_init_default_paths(void)
{
 ...
 do { if(!(psinitialized == 0)) mdvi_crash("%s:%d: Assertion %s failed\n", "fontmap.c", 884, "psinitialized == 0"); } while(0);
...
int mdvi_ps_read_fontmap(const char *name)
{
 ...
 if(pslibdir)
  ...
  fullname = (char *)name;
 in = kpse_fopen_trace(fullname, "rb");
 if(in == ((void*)0)) {
  if(fullname != name)
   mdvi_free(fullname);
  return -1;
 ...
 while((line = dgets(&dstr, in)) != ((void*)0)) {
  char *name;
  char *mapname;
  const char *ext;
  PSFontMap *ps;
  ...
  if(ext && (((ext) != ((void*)0)) && (("gsf") != ((void*)0)) && (strcmp (ext, "gsf") == 0))) {
   __debug ((1 << 17), "(ps) %s: font `%s' ignored\n", name, mapname);

   continue;
  }
  ps = (PSFontMap *)mdvi_hash_lookup(&pstable, ((DviHashKey)(name)));
  if(ps != ((void*)0)) {
   if((((ps->mapname) != ((void*)0)) && ((mapname) != ((void*)0)) && (strcmp (ps->mapname, mapname) == 0)))
    continue;
   __debug ((1 << 17), "(ps) replacing font `%s' (%s) by `%s'\n", name, ps->mapname, mapname);
   ...
   __debug ((1 << 17), "(ps) adding font `%s' as `%s'\n", name, mapname);

   ps = (PSFontMap *)mdvi_malloc(sizeof(PSFontMap));
   ps->psname = mdvi_strdup(name);
   ps->mapname = mdvi_strdup(mapname);
   ps->fullname = ((void*)0);
   listh_append(&psfonts, ((List *)(ps)));
   mdvi_hash_add(&pstable, ((DviHashKey)(ps->psname)),
    ps, 2);
   count++;
  }
 }
 ...
 __debug ((1 << 17), "(ps) %s: %d PostScript fonts registered\n", fullname, count);
...
void mdvi_ps_flush_fonts(void)
{
 ...
 if(!psinitialized)
  return;
 __debug ((1 << 17), "(ps) flushing PS font map (%d) entries\n", psfonts.count);
...
char *mdvi_ps_find_font(const char *psname)
{
 ...
 __debug ((1 << 17), "(ps) resolving PS font `%s'\n", psname);
 if(!psinitialized)
  return ((void*)0);
 map = (PSFontMap *)mdvi_hash_lookup(&pstable, ((DviHashKey)(psname)));
 if(map == ((void*)0))
  return ((void*)0);
 if(map->fullname)
 ...
 while(recursion_limit-- > 0 && smap && *smap->mapname == '/')
  smap = (PSFontMap *)mdvi_hash_lookup(&pstable,
   ((DviHashKey)(smap->mapname + 1)));
 if(smap == ((void*)0)) {
  if(recursion_limit == 0)
   __debug ((1 << 17), "(ps) %s: possible loop in PS font map\n", psname);
...
TFMInfo *mdvi_ps_get_metrics(const char *fontname)
{
 ...
 __debug ((1 << 17), "(ps) %s: looking for metric data\n", fontname);
 info = get_font_metrics(fontname, DviFontAny, ((void*)0));
 if(info != ((void*)0))
  return info;
 ...
 if(psfont == ((void*)0))
  return ((void*)0);
 __debug ((1 << 17), "(ps) %s: found as PS font `%s'\n", fontname, psfont);
 ...
 mdvi_free(psfont);
 __debug ((1 << 17), "(ps) %s: looking for `%s'\n", fontname, afmfile);
 ...
 if(psfont != ((void*)0)) {
  ...
  info = ((void*)0);
 if(info == ((void*)0) || (!map.extend && !map.slant))
  return info;
# 1151 "fontmap.c"
 efactor = (double)map.extend / 10000.0;
 sfactor = (double)map.slant / 10000.0;
 __debug ((1 << 17), "(ps) %s: applying extend=%f, slant=%f\n", efactor, sfactor);
...
# 1170 "fontmap.c"
  if(ch->present) {
   ch->advance = ((efactor * (ch->advance) + sfactor * (0)) >= 0 ? floor((efactor * (ch->advance) + sfactor * (0)) + 0.5) : ceil((efactor * (ch->advance) + sfactor * (0)) - 0.5));
   ch->left = ((efactor * (ch->left) + sfactor * (-ch->depth)) >= 0 ? floor((efactor * (ch->left) + sfactor * (-ch->depth)) + 0.5) : ceil((efactor * (ch->left) + sfactor * (-ch->depth)) - 0.5));
   ch->right = ((efactor * (ch->right) + sfactor * (ch->height)) >= 0 ? floor((efactor * (ch->right) + sfactor * (ch->height)) + 0.5) : ceil((efactor * (ch->right) + sfactor * (ch->height)) - 0.5));
  }
 }
