        ...
        gboolean resident)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (path != ((void*)0) && path[0] != '\0') _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "path != NULL && path[0] != '\\0'"); return (((void*)0)); } } while (0);
