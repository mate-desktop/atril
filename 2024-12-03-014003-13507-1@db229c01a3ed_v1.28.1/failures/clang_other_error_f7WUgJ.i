...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_8; if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 1)) ; else g_assertion_message ("AtrilDocument", "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_9; if ((weak_pointer) == ((void*)0)) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1)) ; else g_assertion_message ("AtrilDocument", "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
   ...
   EvFormFieldTextType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (id >= 0) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (type >= EV_FORM_FIELD_TEXT_NORMAL && type <= EV_FORM_FIELD_TEXT_FILE_SELECT) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_TEXT_NORMAL && type <= EV_FORM_FIELD_TEXT_FILE_SELECT"); return (((void*)0)); } } while (0);
     ...
     EvFormFieldButtonType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (id >= 0) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (type >= EV_FORM_FIELD_BUTTON_PUSH && type <= EV_FORM_FIELD_BUTTON_RADIO) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_BUTTON_PUSH && type <= EV_FORM_FIELD_BUTTON_RADIO"); return (((void*)0)); } } while (0);
     ...
     EvFormFieldChoiceType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (id >= 0) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (type >= EV_FORM_FIELD_CHOICE_COMBO && type <= EV_FORM_FIELD_CHOICE_LIST) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_CHOICE_COMBO && type <= EV_FORM_FIELD_CHOICE_LIST"); return (((void*)0)); } } while (0);
...
ev_form_field_signature_new (gint id)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if (id >= 0) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
