...
ev_backends_manager_load (void)
{
 ...
 while ((dirent = g_dir_read_name (dir))) {
  ...
  if (!(__builtin_constant_p (".atril-backend")? __extension__ ({ const char * const __str = (dirent); const char * const __suffix = (".atril-backend"); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (__str == ((void*)0) || __suffix == ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 0)) __result = (g_str_has_suffix) (__str, __suffix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __suffix_len = strlen (((__suffix) + !(__suffix))); if (__str_len >= __suffix_len) __result = memcmp (__str + __str_len - __suffix_len, ((__suffix) + !(__suffix)), __suffix_len) == 0; } __result; }) : (g_str_has_suffix) (dirent, ".atril-backend") ))
   continue;
