...
ev_render_context_set_page (EvRenderContext *rc,
       EvPage *page)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (rc != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((page)); GType __t = ((ev_page_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_PAGE (page)"); return; } } while (0);
...
ev_render_context_set_rotation (EvRenderContext *rc,
    int rotation)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (rc != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
...
ev_render_context_set_scale (EvRenderContext *rc,
        gdouble scale)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (rc != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "rc != NULL"); return; } } while (0);
