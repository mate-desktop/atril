...
ev_mapping_list_nth (EvMappingList *mapping_list,
                     guint n)
{
        do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (mapping_list != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (((void*)0)); } } while (0);
...
{
        do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (mapping_list != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (0); } } while (0);
       ...
       GDestroyNotify data_destroy_func)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (data_destroy_func != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "data_destroy_func != NULL"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (mapping_list != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (mapping_list->ref_count > 0) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list->ref_count > 0"); return (mapping_list); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (mapping_list != ((void*)0)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list != NULL"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if (mapping_list->ref_count > 0) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "mapping_list->ref_count > 0"); return; } } while (0);
