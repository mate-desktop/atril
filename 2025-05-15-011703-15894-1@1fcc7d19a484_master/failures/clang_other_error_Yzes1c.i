# 1 "ev-document-security.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-document-security.c" 2
# 24 "ev-document-security.c"
# 1 "../config.h" 1
# 25 "ev-document-security.c" 2

# 1 "./ev-document-security.h" 1
# 31 "./ev-document-security.h"
...
# 35 "./ev-document-security.h" 2
# 45 "./ev-document-security.h"
...
void ev_document_security_set_password (EvDocumentSecurity *document_security,
           const char *password);
# 27 "ev-document-security.c" 2

static void ev_document_security_default_init (EvDocumentSecurityInterface *klass); GType ev_document_security_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = g_type_register_static_simple (((GType) ((2) << (2))), g_intern_static_string ("EvDocumentSecurity"), sizeof (EvDocumentSecurityInterface), (GClassInitFunc)(void (*)(void)) ev_document_security_default_init, 0, (GInstanceInitFunc)((void*)0), (GTypeFlags) 0); if (0 != ((GType) ((0) << (2)))) g_type_interface_add_prerequisite (g_define_type_id, 0); { {;;} } (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; }
...
{
 EvDocumentSecurityInterface *iface = ((((EvDocumentSecurityInterface*) g_type_interface_peek (((GTypeInstance*) ((document_security)))->g_class, ((ev_document_security_get_type ()))))));
