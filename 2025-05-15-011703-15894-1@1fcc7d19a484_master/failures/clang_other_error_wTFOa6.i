...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-transition-effect.c" 2
# 21 "ev-transition-effect.c"
# 1 "../config.h" 1
# 22 "ev-transition-effect.c" 2

# 1 "./ev-transition-effect.h" 1
# 28 "./ev-transition-effect.h"
...
# 29 "./ev-transition-effect.h" 2
# 39 "./ev-transition-effect.h"
typedef enum {
...
GType ev_transition_effect_get_type (void) __attribute__ ((__const__));

EvTransitionEffect *ev_transition_effect_new (EvTransitionEffectType type,
              const gchar *first_property_name,
              ...);
# 24 "ev-transition-effect.c" 2
...
static void ev_transition_effect_init (EvTransitionEffect *self); static void ev_transition_effect_class_init (EvTransitionEffectClass *klass); static GType ev_transition_effect_get_type_once (void); static gpointer ev_transition_effect_parent_class = ((void*)0); static gint EvTransitionEffect_private_offset; static void ev_transition_effect_class_intern_init (gpointer klass) { ev_transition_effect_parent_class = g_type_class_peek_parent (klass); if (EvTransitionEffect_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvTransitionEffect_private_offset); ev_transition_effect_class_init ((EvTransitionEffectClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_transition_effect_get_instance_private (EvTransitionEffect *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvTransitionEffect_private_offset)))); } GType ev_transition_effect_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_transition_effect_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_transition_effect_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvTransitionEffect"), sizeof (EvTransitionEffectClass), (GClassInitFunc)(void (*)(void)) ev_transition_effect_class_intern_init, sizeof (EvTransitionEffect), (GInstanceInitFunc)(void (*)(void)) ev_transition_effect_init, (GTypeFlags) 0); { {{ EvTransitionEffect_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EvTransitionEffectPrivate)); };} } return g_define_type_id; }
       ...
       GParamSpec *pspec)
{
 ...
 priv = ev_transition_effect_get_instance_private (((((EvTransitionEffect*) (void *) ((object))))));
 ...
 case PROP_RECTANGULAR:
  priv->rectangular = (g_value_get_boolean (value) != (0));
  break;
 default:
  do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-transition-effect.c", 87, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
  break;
 }
}
       ...
       GParamSpec *pspec)
{
 ...
 case PROP_RECTANGULAR:
  ...
  break;
 default:
  do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((prop_id)); g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "ev-transition-effect.c", 125, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
  break;
 }
}
     ...
     ...)
{
 ...
 object = g_object_new ((ev_transition_effect_get_type ()),
          "type", type,
          ((void*)0));

 __builtin_va_start(args, first_property_name);
 g_object_set_valist (object, first_property_name, args);
 __builtin_va_end(args);

 return ((((EvTransitionEffect*) (void *) ((object)))));
}
