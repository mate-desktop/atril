...
static int tfm_load_font (DviParams *, DviFont *);
static int tfm_font_get_glyph (DviParams *, DviFont *, int);
...
int get_tfm_chars(DviParams *params, DviFont *font, TFMInfo *info, int loaded)
{
 ...
 for(n = info->loc; n <= info->hic; ch++, ptr++, n++) {
  ...
  ch->tfmwidth = (((((ptr->advance) >> 24) & 0xff) == 255) ? ((((((((ptr->advance)) & 0xff) * ((z))) >> 8) + (((((ptr->advance)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->advance)) >> 16) & 0xff) * ((z))) / (beta) - (alpha) : ((((((((ptr->advance)) & 0xff) * ((z))) >> 8) + (((((ptr->advance)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->advance)) >> 16) & 0xff) * ((z))) / (beta));

  a = (((((ptr->left) >> 24) & 0xff) == 255) ? ((((((((ptr->left)) & 0xff) * ((z))) >> 8) + (((((ptr->left)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->left)) >> 16) & 0xff) * ((z))) / (beta) - (alpha) : ((((((((ptr->left)) & 0xff) * ((z))) >> 8) + (((((ptr->left)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->left)) >> 16) & 0xff) * ((z))) / (beta));
  b = (((((ptr->right) >> 24) & 0xff) == 255) ? ((((((((ptr->right)) & 0xff) * ((z))) >> 8) + (((((ptr->right)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->right)) >> 16) & 0xff) * ((z))) / (beta) - (alpha) : ((((((((ptr->right)) & 0xff) * ((z))) >> 8) + (((((ptr->right)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->right)) >> 16) & 0xff) * ((z))) / (beta));
  c = (((((ptr->height) >> 24) & 0xff) == 255) ? ((((((((ptr->height)) & 0xff) * ((z))) >> 8) + (((((ptr->height)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->height)) >> 16) & 0xff) * ((z))) / (beta) - (alpha) : ((((((((ptr->height)) & 0xff) * ((z))) >> 8) + (((((ptr->height)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->height)) >> 16) & 0xff) * ((z))) / (beta));
  d = (((((ptr->depth) >> 24) & 0xff) == 255) ? ((((((((ptr->depth)) & 0xff) * ((z))) >> 8) + (((((ptr->depth)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->depth)) >> 16) & 0xff) * ((z))) / (beta) - (alpha) : ((((((((ptr->depth)) & 0xff) * ((z))) >> 8) + (((((ptr->depth)) >> 8) & 0xff) * ((z)))) >> 8) + ((((ptr->depth)) >> 16) & 0xff) * ((z))) / (beta));


  ch->width = (int)((params->conv * (b - a) * params->hshrink) + 0.5);
  ch->height = (int)((params->vconv * (c - d) * params->vshrink) + 0.5);
  if(ch->height < 0) ch->height = -ch->height;
  ch->x = (int)((params->conv * (a) * params->hshrink) + 0.5);
  ch->y = (int)((params->vconv * (c) * params->vshrink) + 0.5);
...
static int tfm_load_font(DviParams *params, DviFont *font)
{
 ...
 if(tfm->checksum && font->checksum && tfm->checksum != font->checksum) {
  mdvi_warning(((char *) g_dgettext ("atril", "%s: Checksum mismatch (got %u, expected %u)\n")),
...
static int tfm_font_get_glyph(DviParams *params, DviFont *font, int code)
{
 ...
 ch = (((code) < font->loc || (code) > font->hic || !(font)->chars) ? ((void*)0) : &font->chars[(code) - (font)->loc]);
 if(!((ch) && (ch)->offset))
  return -1;
 ch->glyph.x = ch->x;
 ch->glyph.y = ch->y;
