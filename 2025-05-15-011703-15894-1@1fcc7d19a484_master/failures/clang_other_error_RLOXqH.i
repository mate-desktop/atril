                            ...
                            gpointer marshal_data)
{
  ...
  do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (n_param_values == 3) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "n_param_values == 3"); return; } } while (0);
