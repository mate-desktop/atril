...
djvu_text_page_selection (DjvuTextPage *page,
            ...
            int delimit)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return ((0)); } } while (0);
...
djvu_text_page_limits (DjvuTextPage *page,
     ...
     EvRectangle *rect)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return; } } while (0);
    ...
    int position)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (hi >= 0) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "hi >= 0"); return (((miniexp_t)(size_t)0)); } } while (0);
...
djvu_text_page_sexpr (DjvuTextPage *page,
        ...
        miniexp_t end)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return ((0)); } } while (0);
       ...
       gboolean delimit)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return; } } while (0);
         ...
         gboolean case_sensitive)
{
 ...
 while ((haystack = strstr (haystack, search_text)) != ((void*)0)) {
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (result) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "djvu-text-page.c", 396, ((const char*) (__func__)), "result"); } while (0);
