...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_8; if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 1)) ; else g_assertion_message ("AtrilView", "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_9; if ((weak_pointer) == ((void*)0)) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1)) ; else g_assertion_message ("AtrilView", "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
...
ev_timeline_real_start (EvTimeline *timeline)
{
 ...
 if (!priv->source_id) {
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (priv->fps > 0) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1)) ; else g_assertion_message_expr ("AtrilView", "ev-timeline.c", 188, ((const char*) (__func__)), "priv->fps > 0"); } while (0);
...
ev_timeline_pause (EvTimeline *timeline)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return; } } while (0);
...
ev_timeline_rewind (EvTimeline *timeline)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return; } } while (0);
       ...
       guint fps)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return; } } while (0);
...
ev_timeline_get_loop (EvTimeline *timeline)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return ((0)); } } while (0);
        ...
        gboolean loop)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_18; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_18 = 1; else _g_boolean_var_18 = 0; _g_boolean_var_18; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return; } } while (0);
     ...
     guint duration)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_19; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_19 = 1; else _g_boolean_var_19 = 0; _g_boolean_var_19; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return; } } while (0);
...
ev_timeline_get_progress (EvTimeline *timeline)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_21; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((timeline)); GType __t = ((ev_timeline_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_21 = 1; else _g_boolean_var_21 = 0; _g_boolean_var_21; }), 1))) { } else { g_return_if_fail_warning ("AtrilView", ((const char*) (__func__)), "EV_IS_TIMELINE (timeline)"); return (0.0); } } while (0);
