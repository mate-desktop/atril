...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((history)); GType __t = ((ev_history_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_HISTORY (history)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((history)); GType __t = ((ev_history_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_HISTORY (history)"); return (-1); } } while (0);
