...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-document-forms.c" 2
# 21 "ev-document-forms.c"
# 1 "../config.h" 1
# 22 "ev-document-forms.c" 2
# 1 "./ev-document-forms.h" 1
# 28 "./ev-document-forms.h"
...
# 33 "./ev-document-forms.h" 2
# 43 "./ev-document-forms.h"
...
GType ev_document_forms_get_type (void) __attribute__ ((__const__));
...
gchar *ev_document_forms_form_field_choice_get_text (EvDocumentForms *document_forms,
             EvFormField *field);
# 23 "ev-document-forms.c" 2

static void ev_document_forms_default_init (EvDocumentFormsInterface *klass); GType ev_document_forms_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = g_type_register_static_simple (((GType) ((2) << (2))), g_intern_static_string ("EvDocumentForms"), sizeof (EvDocumentFormsInterface), (GClassInitFunc)(void (*)(void)) ev_document_forms_default_init, 0, (GInstanceInitFunc)((void*)0), (GTypeFlags) 0); if (0 != ((GType) ((0) << (2)))) g_type_interface_add_prerequisite (g_define_type_id, 0); { {;;} } (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; }
...
ev_document_forms_get_form_fields (EvDocumentForms *document_forms,
       EvPage *page)
{
 EvDocumentFormsInterface *iface = ((((EvDocumentFormsInterface*) g_type_interface_peek (((GTypeInstance*) ((document_forms)))->g_class, ((ev_document_forms_get_type ()))))));
...
ev_document_forms_document_is_modified (EvDocumentForms *document_forms)
{
 ...
 return (iface->document_is_modified) ? iface->document_is_modified (document_forms) : (0);
}
