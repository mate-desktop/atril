# 1 "ev-document-find.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-document-find.c" 2
# 21 "ev-document-find.c"
# 1 "../config.h" 1
# 22 "ev-document-find.c" 2

# 1 "./ev-document-find.h" 1
# 29 "./ev-document-find.h"
...
# 33 "./ev-document-find.h" 2
# 43 "./ev-document-find.h"
...
GType ev_document_find_get_type (void) __attribute__ ((__const__));
...
guint ev_document_find_check_for_hits (EvDocumentFind *document_find,
                                         ...
                                         const gchar *text,
                                         gboolean case_sensitive);
# 24 "ev-document-find.c" 2

static void ev_document_find_default_init (EvDocumentFindInterface *klass); GType ev_document_find_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = g_type_register_static_simple (((GType) ((2) << (2))), g_intern_static_string ("EvDocumentFind"), sizeof (EvDocumentFindInterface), (GClassInitFunc)(void (*)(void)) ev_document_find_default_init, 0, (GInstanceInitFunc)((void*)0), (GTypeFlags) 0); if (0 != ((GType) ((0) << (2)))) g_type_interface_add_prerequisite (g_define_type_id, 0); { {;;} } (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; }

static void
ev_document_find_default_init (EvDocumentFindInterface *klass)
{
}
# 41 "ev-document-find.c"
GList *
ev_document_find_find_text (EvDocumentFind *document_find,
       ...
       gboolean case_sensitive)
{
 EvDocumentFindInterface *iface = ((((EvDocumentFindInterface*) g_type_interface_peek (((GTypeInstance*) ((document_find)))->g_class, ((ev_document_find_get_type ()))))));
