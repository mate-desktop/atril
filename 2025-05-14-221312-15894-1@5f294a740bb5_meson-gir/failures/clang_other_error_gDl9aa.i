...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-document-transition.c" 2
# 21 "ev-document-transition.c"
# 1 "../config.h" 1
# 22 "ev-document-transition.c" 2
# 1 "./ev-document-transition.h" 1
# 28 "./ev-document-transition.h"
...
EvTransitionEffect *ev_transition_effect_new (EvTransitionEffectType type,
              const gchar *first_property_name,
              ...);
# 32 "./ev-document-transition.h" 2
# 42 "./ev-document-transition.h"
...
GType ev_document_transition_get_type (void) __attribute__ ((__const__));
...
EvTransitionEffect * ev_document_transition_get_effect (EvDocumentTransition *document_trans,
              gint page);
# 23 "ev-document-transition.c" 2

static void ev_document_transition_default_init (EvDocumentTransitionInterface *klass); GType ev_document_transition_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = g_type_register_static_simple (((GType) ((2) << (2))), g_intern_static_string ("EvDocumentTransition"), sizeof (EvDocumentTransitionInterface), (GClassInitFunc)(void (*)(void)) ev_document_transition_default_init, 0, (GInstanceInitFunc)((void*)0), (GTypeFlags) 0); if (0 != ((GType) ((0) << (2)))) g_type_interface_add_prerequisite (g_define_type_id, 0); { {;;} } (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; }
...
ev_document_transition_get_page_duration (EvDocumentTransition *document_trans,
       gint page)
{
 EvDocumentTransitionInterface *iface = ((((EvDocumentTransitionInterface*) g_type_interface_peek (((GTypeInstance*) ((document_trans)))->g_class, ((ev_document_transition_get_type ()))))));
...
# 50 "ev-document-transition.c"
EvTransitionEffect *
ev_document_transition_get_effect (EvDocumentTransition *document_trans,
       gint page)
{
 EvDocumentTransitionInterface *iface = ((((EvDocumentTransitionInterface*) g_type_interface_peek (((GTypeInstance*) ((document_trans)))->g_class, ((ev_document_transition_get_type ()))))));
 EvTransitionEffect *effect = ((void*)0);

 if (iface->get_effect)
  effect = iface->get_effect (document_trans, page);

 if (!effect)
  return ev_transition_effect_new (EV_TRANSITION_EFFECT_REPLACE, ((void*)0));
