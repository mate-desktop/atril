...
static void ev_module_init (EvModule *self); static void ev_module_class_init (EvModuleClass *klass); static GType ev_module_get_type_once (void); static gpointer ev_module_parent_class = ((void*)0); static gint EvModule_private_offset; static void ev_module_class_intern_init (gpointer klass) { ev_module_parent_class = g_type_class_peek_parent (klass); if (EvModule_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvModule_private_offset); ev_module_class_init ((EvModuleClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_module_get_instance_private (EvModule *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvModule_private_offset)))); } GType ev_module_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_module_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_module_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((g_type_module_get_type ()), g_intern_static_string ("EvModule"), sizeof (EvModuleClass), (GClassInitFunc)(void (*)(void)) ev_module_class_intern_init, sizeof (EvModule), (GInstanceInitFunc)(void (*)(void)) ev_module_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }

static gboolean
ev_module_load (GTypeModule *gmodule)
{
        EvModule *module = ((((EvModule*) (void *) ((gmodule)))));
        EvModuleRegisterFunc register_func;

        module->library = g_module_open (module->path, 0);

        if (!module->library) {
                g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "%s", g_module_error ());
        ...
        if (!register_func) {
                g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Symbol 'register_atril_backend' should not be NULL");
                g_module_close (module->library);
        ...
        if (module->type == 0) {
                g_log ("AtrilDocument", G_LOG_LEVEL_WARNING, "Invalid atril backend contained by module %s", module->path);
...
{
        do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((module)); GType __t = ((ev_module_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_MODULE (module)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((module)); GType __t = ((ev_module_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_MODULE (module)"); return (((void*)0)); } } while (0);

        if (module->type == 0)
                return ((void*)0);

        return g_object_new (module->type, ((void*)0));
}

GType
ev_module_get_object_type (EvModule *module)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((module)); GType __t = ((ev_module_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "EV_IS_MODULE (module)"); return (0); } } while (0);
...
{
        EvModule *module = ((((EvModule*) (void *) ((object)))));

        g_free (module->path);

        ((((GObjectClass*) (void *) ((ev_module_parent_class)))))->finalize (object);
}
...
ev_module_class_init (EvModuleClass *class)
{
        ...
        GTypeModuleClass *module_class = ((((GTypeModuleClass*) (void *) ((class)))));
        ...
        gboolean resident)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if (path != ((void*)0) && path[0] != '\0') _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "path != NULL && path[0] != '\\0'"); return (((void*)0)); } } while (0);

        result = g_object_new ((ev_module_get_type ()), ((void*)0));

        g_type_module_set_name (((((GTypeModule*) (void *) ((result))))), path);
        result->path = g_strdup_inline (path);
