...
# 1 "../libdocument/ev-link.h" 1
# 28 "../libdocument/ev-link.h"
# 1 "../libdocument/ev-document.h" 1
# 32 "../libdocument/ev-document.h"
...
# 29 "../libdocument/ev-link.h" 2
# 1 "../libdocument/ev-link-action.h" 1
# 29 "../libdocument/ev-link-action.h"
# 1 "../libdocument/ev-link-dest.h" 1
# 32 "../libdocument/ev-link-dest.h"
...
# 30 "../libdocument/ev-link-action.h" 2
...
# 44 "../libdocument/ev-link-action.h"
typedef enum {
...
static void ev_history_init (EvHistory *self); static void ev_history_class_init (EvHistoryClass *klass); static GType ev_history_get_type_once (void); static gpointer ev_history_parent_class = ((void*)0); static gint EvHistory_private_offset; static void ev_history_class_intern_init (gpointer klass) { ev_history_parent_class = g_type_class_peek_parent (klass); if (EvHistory_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvHistory_private_offset); ev_history_class_init ((EvHistoryClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_history_get_instance_private (EvHistory *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvHistory_private_offset)))); } GType ev_history_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_history_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_history_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvHistory"), sizeof (EvHistoryClass), (GClassInitFunc)(void (*)(void)) ev_history_class_intern_init, sizeof (EvHistory), (GInstanceInitFunc)(void (*)(void)) ev_history_init, (GTypeFlags) 0); { {{ EvHistory_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EvHistoryPrivate)); };} } return g_define_type_id; }
...
ev_history_init (EvHistory *history)
{
 ...
 history->priv->links = ((void*)0);
}

static void
free_links_list (GList *l)
{
 g_list_foreach (l, (GFunc)g_object_unref, ((void*)0));
 g_list_free (l);
}
...
{
 EvHistory *history = ((((EvHistory*) (void *) ((object)))));

 free_links_list (history->priv->links);

 ((((GObjectClass*) (void *) ((ev_history_parent_class)))))->finalize (object);
}
...
ev_history_class_init (EvHistoryClass *class)
{
 ...
 signals[HISTORY_CHANGED] =
      ...
      ((glong) __builtin_offsetof(EvHistoryClass, changed)),
      ((void*)0), ((void*)0),
...
ev_history_add_link (EvHistory *history, EvLink *link)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((history)); GType __t = ((ev_history_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_HISTORY (history)"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((link)); GType __t = ((ev_link_get_type())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_LINK (link)"); return; } } while (0);

 for (l = history->priv->links; l; l = l->next) {
  if (!strcmp (ev_link_get_title (((((EvLink*) (void *) ((l->data)))))), ev_link_get_title (link))) {
   g_object_unref (((((GObject*) (void *) ((l->data))))));
   history->priv->links = g_list_delete_link (history->priv->links, l);
   break;
  }
 }

 ((__typeof__ (link)) (g_object_ref) (link));
 history->priv->links = g_list_append (history->priv->links,
           link);

 if (g_list_length (history->priv->links) > 7) {
  g_object_unref (((((GObject*) (void *) ((history->priv->links->data))))));
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((history)); GType __t = ((ev_history_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_HISTORY (history)"); return (((void*)0)); } } while (0);

 return ((((EvLink*) (void *) ((g_list_nth_data (history->priv->links, index))))));
}

int
ev_history_get_n_links (EvHistory *history)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((history)); GType __t = ((ev_history_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "EV_IS_HISTORY (history)"); return (-1); } } while (0);
...
ev_history_new (void)
{
 return ((((EvHistory*) (void *) ((g_object_new ((ev_history_get_type ()), ((void*)0)))))));
}
