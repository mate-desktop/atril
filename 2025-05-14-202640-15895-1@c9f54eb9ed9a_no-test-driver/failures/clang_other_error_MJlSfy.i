...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "djvu-text-page.c" 2
# 20 "djvu-text-page.c"
# 1 "../../config.h" 1
# 21 "djvu-text-page.c" 2
...
g_bit_nth_lsf_impl (gulong mask,
                    gint nth_bit)
{
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_0 = 0; if (nth_bit < -1) _g_boolean_var_0 = 1; _g_boolean_var_0; }), 0)))
    nth_bit = -1;
  while (nth_bit < ((8 * 8) - 1))
    {
      nth_bit++;
...
g_bit_nth_msf_impl (gulong mask,
                    gint nth_bit)
{
  if (nth_bit < 0 || (__builtin_expect (__extension__ ({ int _g_boolean_var_1 = 0; if (nth_bit > 8 * 8) _g_boolean_var_1 = 1; _g_boolean_var_1; }), 0)))
    nth_bit = 8 * 8;
  while (nth_bit > 0)
    {
      nth_bit--;
...
g_bit_storage_impl (gulong number)
{
  ...
  return (__builtin_expect (__extension__ ({ int _g_boolean_var_2 = 0; if (number) _g_boolean_var_2 = 1; _g_boolean_var_2; }), 1)) ?
...
g_string_append_c_inline (GString *gstring,
                          gchar c)
{
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_3 = 0; if (gstring != ((void*)0) && gstring->len + 1 < gstring->allocated_len) _g_boolean_var_3 = 1; _g_boolean_var_3; }), 1)))
                            ...
                            gssize len)
{
  ...
  if (__builtin_expect (__extension__ ({ int _g_boolean_var_4 = 0; if (gstring == ((void*)0)) _g_boolean_var_4 = 1; _g_boolean_var_4; }), 0))
    return g_string_append_len (gstring, val, len);

  if (__builtin_expect (__extension__ ({ int _g_boolean_var_5 = 0; if (val == ((void*)0)) _g_boolean_var_5 = 1; _g_boolean_var_5; }), 0))
  ...
  if ((__builtin_expect (__extension__ ({ int _g_boolean_var_6 = 0; if (gstring->len + len_unsigned < gstring->allocated_len) _g_boolean_var_6 = 1; _g_boolean_var_6; }), 1)))
    {
      char *end = gstring->str + gstring->len;
      if ((__builtin_expect (__extension__ ({ int _g_boolean_var_7 = 0; if (val + len_unsigned <= end || val > end + len_unsigned) _g_boolean_var_7 = 1; _g_boolean_var_7; }), 1)))
...
# 23 "djvu-text-page.c" 2
# 1 "/usr/include/libdjvu/miniexp.h" 1 3 4
# 54 "/usr/include/libdjvu/miniexp.h" 3 4
# 1 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 1 3 4
# 88 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 3 4
# 1 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/__stddef_ptrdiff_t.h" 1 3 4
# 89 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 2 3 4
...
# 1 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/__stddef_wchar_t.h" 1 3 4
# 104 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 2 3 4
# 128 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 3 4
# 1 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/__stddef_offsetof.h" 1 3 4
# 129 "/usr/lib64/llvm20/bin/../../../lib/clang/20/include/stddef.h" 2 3 4
# 55 "/usr/include/libdjvu/miniexp.h" 2 3 4
# 71 "/usr/include/libdjvu/miniexp.h" 3 4
typedef struct miniexp_s* miniexp_t;
# 90 "/usr/include/libdjvu/miniexp.h" 3 4
static __inline__ int miniexp_numberp(miniexp_t p) {
  return (((size_t)(p)&3)==3);
}
...
static __inline__ int miniexp_to_int(miniexp_t p) {
...
static __inline__ miniexp_t miniexp_number(int x) {
  return (miniexp_t) (size_t) ((x<<2)|3);
}
# 123 "/usr/include/libdjvu/miniexp.h" 3 4
static __inline__ int miniexp_symbolp(miniexp_t p) {
  return ((((size_t)p)&3)==2);
}
            ...
            const char* miniexp_to_name(miniexp_t p);




            miniexp_t miniexp_symbol(const char *name);
# 163 "/usr/include/libdjvu/miniexp.h" 3 4
static __inline__ int miniexp_listp(miniexp_t p) {
  return ((((size_t)p)&3)==0);
}
...
static __inline__ int miniexp_consp(miniexp_t p) {
  return p && miniexp_listp(p);
            ...
            int miniexp_length(miniexp_t p);





static __inline__ miniexp_t miniexp_car(miniexp_t p) {
  if (miniexp_consp(p))
    return ((miniexp_t*)p)[0];
  return ((miniexp_t)(size_t)0);
}

static __inline__ miniexp_t miniexp_cdr(miniexp_t p) {
  if (miniexp_consp(p))
  ...
  return ((miniexp_t)(size_t)0);
            ...
            miniexp_t miniexp_caar (miniexp_t p);
            miniexp_t miniexp_cadr (miniexp_t p);
            miniexp_t miniexp_cdar (miniexp_t p);
            miniexp_t miniexp_cddr (miniexp_t p);
            miniexp_t miniexp_caddr(miniexp_t p);
            miniexp_t miniexp_cdddr(miniexp_t p);




            miniexp_t miniexp_nth(int n, miniexp_t l);




            miniexp_t miniexp_cons(miniexp_t car, miniexp_t cdr);





            miniexp_t miniexp_rplaca(miniexp_t pair, miniexp_t newcar);
            miniexp_t miniexp_rplacd(miniexp_t pair, miniexp_t newcdr);




            miniexp_t miniexp_reverse(miniexp_t p);
# 239 "/usr/include/libdjvu/miniexp.h" 3 4
static __inline__ int miniexp_objectp(miniexp_t p) {
  return ((((size_t)p)&3)==1);
}
            ...
            miniexp_t miniexp_classof(miniexp_t p);
            ...
            miniexp_t miniexp_isa(miniexp_t p, miniexp_t c);
            ...
            int miniexp_stringp(miniexp_t p);
            ...
            const char *miniexp_to_str(miniexp_t p);
            ...
            size_t miniexp_to_lstr(miniexp_t p, const char **sp);
            ...
            miniexp_t miniexp_lstring(size_t len, const char *s);





            miniexp_t miniexp_substring(const char *s, int len);




            miniexp_t miniexp_concat(miniexp_t l);
# 308 "/usr/include/libdjvu/miniexp.h" 3 4
            int miniexp_floatnump(miniexp_t p);




            miniexp_t miniexp_floatnum(double x);





            int miniexp_doublep(miniexp_t p);





            double miniexp_to_double(miniexp_t p);
            ...
            miniexp_t miniexp_double(double x);
# 403 "/usr/include/libdjvu/miniexp.h" 3 4
            void minilisp_gc(void);




            void minilisp_info(void);
# 434 "/usr/include/libdjvu/miniexp.h" 3 4
            miniexp_t minilisp_acquire_gc_lock(miniexp_t);
            miniexp_t minilisp_release_gc_lock(miniexp_t);
...
typedef struct minivar_s minivar_t;
            ...
            minivar_t *minivar_alloc(void);
            void minivar_free(minivar_t *v);
            ...
            miniexp_t *minivar_pointer(minivar_t *v);
            ...
            void minilisp_debug(int debugflag);
            ...
            void minilisp_finish(void);
# 542 "/usr/include/libdjvu/miniexp.h" 3 4
            miniexp_t miniexp_pname(miniexp_t p, int width);
# 572 "/usr/include/libdjvu/miniexp.h" 3 4
...
# 602 "/usr/include/libdjvu/miniexp.h" 3 4
            void miniexp_io_init(miniexp_io_t *io);
# 618 "/usr/include/libdjvu/miniexp.h" 3 4
            miniexp_t miniexp_read_r(miniexp_io_t *io);
            ...
            miniexp_t miniexp_prin_r(miniexp_io_t *io, miniexp_t p);
            miniexp_t miniexp_print_r(miniexp_io_t *io, miniexp_t p);
            ...
            miniexp_t miniexp_pprin_r(miniexp_io_t *io, miniexp_t p, int w);
            miniexp_t miniexp_pprint_r(miniexp_io_t *io, miniexp_t p, int w);





extern miniexp_io_t miniexp_io;
            miniexp_t miniexp_read(void);
            miniexp_t miniexp_prin(miniexp_t p);
            miniexp_t miniexp_print(miniexp_t p);
            miniexp_t miniexp_pprin(miniexp_t p, int width);
            miniexp_t miniexp_pprint(miniexp_t p, int width);



extern int (*minilisp_puts)(const char *);
extern int (*minilisp_getc)(void);
extern int (*minilisp_ungetc)(int);
extern miniexp_t (*minilisp_macrochar_parser[128])(void);
extern miniexp_t (*minilisp_diezechar_parser[128])(void);
extern miniexp_macrochar_t miniexp_macrochar[128];
extern minivar_t miniexp_macroqueue;
extern int minilisp_print_7bits;
# 24 "djvu-text-page.c" 2
# 1 "./djvu-text-page.h" 1
# 22 "./djvu-text-page.h"
# 1 "../../libdocument/ev-document.h" 1
...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_8 = 0; if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) _g_boolean_var_8 = 1; _g_boolean_var_8; }), 1)) ; else g_assertion_message (((gchar*) 0), "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_9 = 0; if ((weak_pointer) == ((void*)0)) _g_boolean_var_9 = 1; _g_boolean_var_9; }), 1)) ; else g_assertion_message (((gchar*) 0), "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 41 "/usr/include/glib-2.0/gobject/gtypemodule.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GTypeModule (GTypeModule *_ptr) { if (_ptr) (g_object_unref) ((GTypeModule *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GTypeModule (GTypeModule **_ptr) { glib_autoptr_clear_GTypeModule (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GTypeModule (void *_ptr) { (g_object_unref) ((GTypeModule *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GTypeModule (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GTypeModule); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GTypeModule (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GTypeModule); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GTypeModule (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GTypeModule); }
# 41 "/usr/include/glib-2.0/gobject/gtypemodule.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 28 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GClosure (GClosure *_ptr) { if (_ptr) (g_closure_unref) ((GClosure *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GClosure (GClosure **_ptr) { glib_autoptr_clear_GClosure (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GClosure (void *_ptr) { (g_closure_unref) ((GClosure *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GClosure (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GClosure); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GClosure (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GClosure); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GClosure (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GClosure); }
# 28 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 29 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GEnumClass (GEnumClass *_ptr) { if (_ptr) (g_type_class_unref) ((GEnumClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GEnumClass (GEnumClass **_ptr) { glib_autoptr_clear_GEnumClass (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GEnumClass (void *_ptr) { (g_type_class_unref) ((GEnumClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GEnumClass (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GEnumClass); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GEnumClass (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GEnumClass); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GEnumClass (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GEnumClass); }
# 29 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 30 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GFlagsClass (GFlagsClass *_ptr) { if (_ptr) (g_type_class_unref) ((GFlagsClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GFlagsClass (GFlagsClass **_ptr) { glib_autoptr_clear_GFlagsClass (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GFlagsClass (void *_ptr) { (g_type_class_unref) ((GFlagsClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GFlagsClass (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GFlagsClass); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GFlagsClass (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GFlagsClass); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GFlagsClass (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GFlagsClass); }
# 30 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 31 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GObject (GObject *_ptr) { if (_ptr) (g_object_unref) ((GObject *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GObject (GObject **_ptr) { glib_autoptr_clear_GObject (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GObject (void *_ptr) { (g_object_unref) ((GObject *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GObject (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GObject); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GObject (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GObject); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GObject (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GObject); }
# 31 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 32 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GInitiallyUnowned (GInitiallyUnowned *_ptr) { if (_ptr) (g_object_unref) ((GInitiallyUnowned *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GInitiallyUnowned (GInitiallyUnowned **_ptr) { glib_autoptr_clear_GInitiallyUnowned (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GInitiallyUnowned (void *_ptr) { (g_object_unref) ((GInitiallyUnowned *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GInitiallyUnowned (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GInitiallyUnowned); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GInitiallyUnowned (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GInitiallyUnowned); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GInitiallyUnowned (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GInitiallyUnowned); }
# 32 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 33 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GParamSpec (GParamSpec *_ptr) { if (_ptr) (g_param_spec_unref) ((GParamSpec *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GParamSpec (GParamSpec **_ptr) { glib_autoptr_clear_GParamSpec (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GParamSpec (void *_ptr) { (g_param_spec_unref) ((GParamSpec *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GParamSpec (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GParamSpec); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GParamSpec (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GParamSpec); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GParamSpec (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GParamSpec); }
# 33 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 34 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_autoptr_clear_GTypeClass (GTypeClass *_ptr) { if (_ptr) (g_type_class_unref) ((GTypeClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_cleanup_GTypeClass (GTypeClass **_ptr) { glib_autoptr_clear_GTypeClass (*_ptr); } static __attribute__ ((__unused__)) __inline__ void glib_autoptr_destroy_GTypeClass (void *_ptr) { (g_type_class_unref) ((GTypeClass *) _ptr); } static __attribute__ ((__unused__)) __inline__ void glib_listautoptr_cleanup_GTypeClass (GList **_l) { g_list_free_full (*_l, glib_autoptr_destroy_GTypeClass); } static __attribute__ ((__unused__)) __inline__ void glib_slistautoptr_cleanup_GTypeClass (GSList **_l) { g_slist_free_full (*_l, glib_autoptr_destroy_GTypeClass); } static __attribute__ ((__unused__)) __inline__ void glib_queueautoptr_cleanup_GTypeClass (GQueue **_q) { if (*_q) g_queue_free_full (*_q, glib_autoptr_destroy_GTypeClass); }
# 34 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
#pragma clang diagnostic push
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
# 35 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
 static __attribute__ ((__unused__)) __inline__ void glib_auto_cleanup_GValue (GValue *_ptr) { (g_value_unset) (_ptr); }
# 35 "/usr/include/glib-2.0/gobject/gobject-autocleanups.h"
#pragma clang diagnostic pop
# 43 "/usr/include/glib-2.0/glib-object.h" 2
# 31 "../../libdocument/ev-document.h" 2
...
# 33 "../../libdocument/ev-document.h" 2
...
# 34 "../../libdocument/ev-document.h" 2

# 1 "../../libdocument/ev-document-info.h" 1
# 33 "../../libdocument/ev-document-info.h"
...
typedef enum
{
 ...
 EV_DOCUMENT_MODE_PRESENTATION = EV_DOCUMENT_MODE_FULL_SCREEN
} EvDocumentMode;
...
typedef enum
{
 ...
 EV_DOCUMENT_PERMISSIONS_FULL = (EV_DOCUMENT_PERMISSIONS_OK_TO_PRINT | EV_DOCUMENT_PERMISSIONS_OK_TO_MODIFY | EV_DOCUMENT_PERMISSIONS_OK_TO_COPY | EV_DOCUMENT_PERMISSIONS_OK_TO_ADD_NOTES)
...
GType ev_document_info_get_type (void) __attribute__ ((__const__));
...
GType ev_document_license_get_type (void) __attribute__ ((__const__));
...
# 36 "../../libdocument/ev-document.h" 2
# 1 "../../libdocument/ev-page.h" 1
# 38 "../../libdocument/ev-page.h"
...
GType ev_page_get_type (void) __attribute__ ((__const__));

EvPage *ev_page_new (gint index);
# 37 "../../libdocument/ev-document.h" 2
# 1 "../../libdocument/ev-render-context.h" 1
# 29 "../../libdocument/ev-render-context.h"
# 1 "../../libdocument/ev-page.h" 1
# 30 "../../libdocument/ev-render-context.h" 2
...
GType ev_render_context_get_type (void) __attribute__ ((__const__));
...
void ev_render_context_set_scale (EvRenderContext *rc,
          gdouble scale);
# 38 "../../libdocument/ev-document.h" 2
...
GType ev_document_get_type (void) __attribute__ ((__const__));
...
GType ev_rectangle_get_type (void) __attribute__ ((__const__));
...
GType ev_source_link_get_type (void) __attribute__ ((__const__));
                                  ...
                                  int delimit)
{
 if (page->text || p == page->start) {
  ...
  if (page->text) {
   ...
   page->text = g_strdup_inline (token_text);
  if (p == page->end)
   return (0);
 }
 return (!(0));
...
djvu_text_page_selection (DjvuTextPage *page,
            ...
            int delimit)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return ((0)); } } while (0);
 ...
 while (deeper != ((miniexp_t)(size_t)0)) {
          ...
          EvRectangle *rect)
{
 ...
 if (current.x2 >= rect->x1 && current.y1 <= rect->y2 &&
     current.x1 <= rect->x2 && current.y2 >= rect->y1) {
      if (page->start == ((miniexp_t)(size_t)0))
       page->start = p;
      page->end = p;
 }
}
...
djvu_text_page_limits (DjvuTextPage *page,
     ...
     EvRectangle *rect)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return; } } while (0);
       ...
       EvRectangle *rectangle)
{
 ...
 page->start = ((miniexp_t)(size_t)0);
 page->end = ((miniexp_t)(size_t)0);
    ...
    int position)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if (hi >= 0) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "hi >= 0"); return (((miniexp_t)(size_t)0)); } } while (0);


 while (low <= hi) {
  mid = (low + hi) >> 1;
  DjvuTextLink *link =
      &(((DjvuTextLink*) (void *) (links)->data) [(mid)]);
 ...
 return (((DjvuTextLink*) (void *) (page->links)->data) [(mid)]).pair;
}
# 202 "djvu-text-page.c"
static void
...
djvu_text_page_sexpr (DjvuTextPage *page,
        ...
        miniexp_t end)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return ((0)); } } while (0);
       ...
       gboolean delimit)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14 = 0; if (miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))) _g_boolean_var_14 = 1; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "miniexp_consp (p) && miniexp_symbolp (miniexp_car (p))"); return; } } while (0);
 ...
 while (deeper != ((miniexp_t)(size_t)0)) {
  ...
  if (miniexp_stringp (data)) {
   DjvuTextLink link;
   link.position = page->text == ((void*)0) ? 0 :
       strlen (page->text);
   link.pair = p;
   g_array_append_vals (page->links, &(link), 1);
         ...
         gboolean case_sensitive)
{
 ...
 if (case_sensitive)
  search_text = g_strdup_inline (text);
 else
  search_text = g_utf8_casefold (text, search_len);

 while ((haystack = strstr (haystack, search_text)) != ((void*)0)) {
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_15 = 0; if (result) _g_boolean_var_15 = 1; _g_boolean_var_15; }), 1)) ; else g_assertion_message_expr (((gchar*) 0), "djvu-text-page.c", 396, ((const char*) (__func__)), "result"); } while (0);
...
# 428 "djvu-text-page.c"
DjvuTextPage *
djvu_text_page_new (miniexp_t text)
{
 DjvuTextPage *page;

 page = (DjvuTextPage *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (DjvuTextPage); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 page->links = g_array_new ((0), (0), sizeof (DjvuTextLink));
