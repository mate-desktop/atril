# 1 "ev-file-exporter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ev-file-exporter.c" 2
# 23 "ev-file-exporter.c"
# 1 "../config.h" 1
# 24 "ev-file-exporter.c" 2
# 1 "./ev-file-exporter.h" 1
# 30 "./ev-file-exporter.h"
...
GType ev_file_exporter_get_type (void) __attribute__ ((__const__));
...
# 26 "ev-file-exporter.c" 2

static void ev_file_exporter_default_init (EvFileExporterInterface *klass); GType ev_file_exporter_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = g_type_register_static_simple (((GType) ((2) << (2))), g_intern_static_string ("EvFileExporter"), sizeof (EvFileExporterInterface), (GClassInitFunc)(void (*)(void)) ev_file_exporter_default_init, 0, (GInstanceInitFunc)((void*)0), (GTypeFlags) 0); if (0 != ((GType) ((0) << (2)))) g_type_interface_add_prerequisite (g_define_type_id, 0); { {;;} } (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; }
...
ev_file_exporter_begin (EvFileExporter *exporter,
                        EvFileExporterContext *fc)
{
        EvFileExporterInterface *iface = ((((EvFileExporterInterface*) g_type_interface_peek (((GTypeInstance*) ((exporter)))->g_class, ((ev_file_exporter_get_type ()))))));
