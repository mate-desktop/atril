...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_8 = 0; if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) _g_boolean_var_8 = 1; _g_boolean_var_8; }), 1)) ; else g_assertion_message ("AtrilDocument", "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if (__builtin_expect (__extension__ ({ int _g_boolean_var_9 = 0; if ((weak_pointer) == ((void*)0)) _g_boolean_var_9 = 1; _g_boolean_var_9; }), 1)) ; else g_assertion_message ("AtrilDocument", "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
...
# 1 "./ev-document-info.h" 1
# 33 "./ev-document-info.h"
...
# 37 "./ev-document.h" 2
# 1 "./ev-render-context.h" 1
# 29 "./ev-render-context.h"
# 1 "./ev-page.h" 1
# 30 "./ev-render-context.h" 2
...
# 31 "./ev-form-field.h" 2
# 1 "./ev-link.h" 1
# 28 "./ev-link.h"
# 1 "./ev-document.h" 1
# 29 "./ev-link.h" 2
# 1 "./ev-link-action.h" 1
# 29 "./ev-link-action.h"
# 1 "./ev-link-dest.h" 1
# 32 "./ev-link-dest.h"
...
GType ev_link_dest_get_type (void) __attribute__ ((__const__));
...
GType ev_link_action_get_type (void) __attribute__ ((__const__));
...
# 44 "./ev-link.h"
GType ev_link_get_type (void) __attribute__ ((__const__));
...
GType ev_form_field_get_type (void) __attribute__ ((__const__));


GType ev_form_field_text_get_type (void) __attribute__ ((__const__));
EvFormField *ev_form_field_text_new (gint id,
            EvFormFieldTextType type);


GType ev_form_field_button_get_type (void) __attribute__ ((__const__));
EvFormField *ev_form_field_button_new (gint id,
            EvFormFieldButtonType type);


GType ev_form_field_choice_get_type (void) __attribute__ ((__const__));
EvFormField *ev_form_field_choice_new (gint id,
            EvFormFieldChoiceType type);


GType ev_form_field_signature_get_type (void) __attribute__ ((__const__));
EvFormField *ev_form_field_signature_new (gint id);
# 24 "ev-form-field.c" 2

static void ev_form_field_init (EvFormField *self); static void ev_form_field_class_init (EvFormFieldClass *klass); static GType ev_form_field_get_type_once (void); static gpointer ev_form_field_parent_class = ((void*)0); static gint EvFormField_private_offset; static void ev_form_field_class_intern_init (gpointer klass) { ev_form_field_parent_class = g_type_class_peek_parent (klass); if (EvFormField_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvFormField_private_offset); ev_form_field_class_init ((EvFormFieldClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_form_field_get_instance_private (EvFormField *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvFormField_private_offset)))); } GType ev_form_field_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_form_field_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_form_field_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EvFormField"), sizeof (EvFormFieldClass), (GClassInitFunc)(void (*)(void)) ev_form_field_class_intern_init, sizeof (EvFormField), (GInstanceInitFunc)(void (*)(void)) ev_form_field_init, (GTypeFlags) G_TYPE_FLAG_ABSTRACT); { {{};} } return g_define_type_id; }
static void ev_form_field_text_init (EvFormFieldText *self); static void ev_form_field_text_class_init (EvFormFieldTextClass *klass); static GType ev_form_field_text_get_type_once (void); static gpointer ev_form_field_text_parent_class = ((void*)0); static gint EvFormFieldText_private_offset; static void ev_form_field_text_class_intern_init (gpointer klass) { ev_form_field_text_parent_class = g_type_class_peek_parent (klass); if (EvFormFieldText_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvFormFieldText_private_offset); ev_form_field_text_class_init ((EvFormFieldTextClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_form_field_text_get_instance_private (EvFormFieldText *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvFormFieldText_private_offset)))); } GType ev_form_field_text_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_form_field_text_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_form_field_text_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((ev_form_field_get_type()), g_intern_static_string ("EvFormFieldText"), sizeof (EvFormFieldTextClass), (GClassInitFunc)(void (*)(void)) ev_form_field_text_class_intern_init, sizeof (EvFormFieldText), (GInstanceInitFunc)(void (*)(void)) ev_form_field_text_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
static void ev_form_field_button_init (EvFormFieldButton *self); static void ev_form_field_button_class_init (EvFormFieldButtonClass *klass); static GType ev_form_field_button_get_type_once (void); static gpointer ev_form_field_button_parent_class = ((void*)0); static gint EvFormFieldButton_private_offset; static void ev_form_field_button_class_intern_init (gpointer klass) { ev_form_field_button_parent_class = g_type_class_peek_parent (klass); if (EvFormFieldButton_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvFormFieldButton_private_offset); ev_form_field_button_class_init ((EvFormFieldButtonClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_form_field_button_get_instance_private (EvFormFieldButton *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvFormFieldButton_private_offset)))); } GType ev_form_field_button_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_form_field_button_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_form_field_button_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((ev_form_field_get_type()), g_intern_static_string ("EvFormFieldButton"), sizeof (EvFormFieldButtonClass), (GClassInitFunc)(void (*)(void)) ev_form_field_button_class_intern_init, sizeof (EvFormFieldButton), (GInstanceInitFunc)(void (*)(void)) ev_form_field_button_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
static void ev_form_field_choice_init (EvFormFieldChoice *self); static void ev_form_field_choice_class_init (EvFormFieldChoiceClass *klass); static GType ev_form_field_choice_get_type_once (void); static gpointer ev_form_field_choice_parent_class = ((void*)0); static gint EvFormFieldChoice_private_offset; static void ev_form_field_choice_class_intern_init (gpointer klass) { ev_form_field_choice_parent_class = g_type_class_peek_parent (klass); if (EvFormFieldChoice_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvFormFieldChoice_private_offset); ev_form_field_choice_class_init ((EvFormFieldChoiceClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_form_field_choice_get_instance_private (EvFormFieldChoice *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvFormFieldChoice_private_offset)))); } GType ev_form_field_choice_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_form_field_choice_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_form_field_choice_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((ev_form_field_get_type()), g_intern_static_string ("EvFormFieldChoice"), sizeof (EvFormFieldChoiceClass), (GClassInitFunc)(void (*)(void)) ev_form_field_choice_class_intern_init, sizeof (EvFormFieldChoice), (GInstanceInitFunc)(void (*)(void)) ev_form_field_choice_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
static void ev_form_field_signature_init (EvFormFieldSignature *self); static void ev_form_field_signature_class_init (EvFormFieldSignatureClass *klass); static GType ev_form_field_signature_get_type_once (void); static gpointer ev_form_field_signature_parent_class = ((void*)0); static gint EvFormFieldSignature_private_offset; static void ev_form_field_signature_class_intern_init (gpointer klass) { ev_form_field_signature_parent_class = g_type_class_peek_parent (klass); if (EvFormFieldSignature_private_offset != 0) g_type_class_adjust_private_offset (klass, &EvFormFieldSignature_private_offset); ev_form_field_signature_class_init ((EvFormFieldSignatureClass*) klass); } __attribute__ ((__unused__)) static inline gpointer ev_form_field_signature_get_instance_private (EvFormFieldSignature *self) { return (((gpointer) ((guint8*) (self) + (glong) (EvFormFieldSignature_private_offset)))); } GType ev_form_field_signature_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = ev_form_field_signature_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType ev_form_field_signature_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((ev_form_field_get_type()), g_intern_static_string ("EvFormFieldSignature"), sizeof (EvFormFieldSignatureClass), (GClassInitFunc)(void (*)(void)) ev_form_field_signature_class_intern_init, sizeof (EvFormFieldSignature), (GInstanceInitFunc)(void (*)(void)) ev_form_field_signature_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; }
...
ev_form_field_init (EvFormField *field)
{
 field->page = ((void*)0);
 field->changed = (0);
 field->is_read_only = (0);
}

static void
ev_form_field_finalize (GObject *object)
{
 EvFormField *field = ((((EvFormField*) (void *) ((object)))));

 g_object_unref (field->page);
 field->page = ((void*)0);

 do { _Static_assert (sizeof *((&field->activation_link)) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (((&field->activation_link))) _pp = ((&field->activation_link)); __typeof__ (*((&field->activation_link))) _ptr = *_pp; *_pp = ((void*)0); if (_ptr) (g_object_unref) (_ptr); } while (0) ;

 (* ((((GObjectClass*) (void *) ((ev_form_field_parent_class)))))->finalize) (object);
}
...
{
 EvFormFieldText *field_text = ((((EvFormFieldText*) (void *) ((object)))));

 if (field_text->text) {
  g_free (field_text->text);
  field_text->text = ((void*)0);
 }

 (* ((((GObjectClass*) (void *) ((ev_form_field_text_parent_class)))))->finalize) (object);
}
...
{
 EvFormFieldChoice *field_choice = ((((EvFormFieldChoice*) (void *) ((object)))));

 if (field_choice->selected_items) {
  g_list_free (field_choice->selected_items);
  field_choice->selected_items = ((void*)0);
 }

 if (field_choice->text) {
  g_free (field_choice->text);
  field_choice->text = ((void*)0);
 }

 (* ((((GObjectClass*) (void *) ((ev_form_field_choice_parent_class)))))->finalize) (object);
}
   ...
   EvFormFieldTextType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10 = 0; if (id >= 0) _g_boolean_var_10 = 1; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11 = 0; if (type >= EV_FORM_FIELD_TEXT_NORMAL && type <= EV_FORM_FIELD_TEXT_FILE_SELECT) _g_boolean_var_11 = 1; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_TEXT_NORMAL && type <= EV_FORM_FIELD_TEXT_FILE_SELECT"); return (((void*)0)); } } while (0);


 field = ((((EvFormField*) (void *) ((g_object_new ((ev_form_field_text_get_type()), ((void*)0)))))));
 field->id = id;
 ((((EvFormFieldText*) (void *) ((field)))))->type = type;
     ...
     EvFormFieldButtonType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12 = 0; if (id >= 0) _g_boolean_var_12 = 1; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13 = 0; if (type >= EV_FORM_FIELD_BUTTON_PUSH && type <= EV_FORM_FIELD_BUTTON_RADIO) _g_boolean_var_13 = 1; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_BUTTON_PUSH && type <= EV_FORM_FIELD_BUTTON_RADIO"); return (((void*)0)); } } while (0);


 field = ((((EvFormField*) (void *) ((g_object_new ((ev_form_field_button_get_type()), ((void*)0)))))));
 field->id = id;
 ((((EvFormFieldButton*) (void *) ((field)))))->type = type;
     ...
     EvFormFieldChoiceType type)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14 = 0; if (id >= 0) _g_boolean_var_14 = 1; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15 = 0; if (type >= EV_FORM_FIELD_CHOICE_COMBO && type <= EV_FORM_FIELD_CHOICE_LIST) _g_boolean_var_15 = 1; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "type >= EV_FORM_FIELD_CHOICE_COMBO && type <= EV_FORM_FIELD_CHOICE_LIST"); return (((void*)0)); } } while (0);


 field = ((((EvFormField*) (void *) ((g_object_new ((ev_form_field_choice_get_type()), ((void*)0)))))));
 field->id = id;
 ((((EvFormFieldChoice*) (void *) ((field)))))->type = type;
...
ev_form_field_signature_new (gint id)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16 = 0; if (id >= 0) _g_boolean_var_16 = 1; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning ("AtrilDocument", ((const char*) (__func__)), "id >= 0"); return (((void*)0)); } } while (0);

 field = ((((EvFormField*) (void *) ((g_object_new ((ev_form_field_signature_get_type()), ((void*)0)))))));
 field->id = id;
